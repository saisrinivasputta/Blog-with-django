...
SECRET_KEY = 'm(p6c*#xh)#1yf3#moyxo%-7kulf&crhp_9!1bm&b9-46==@8n'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'templates/blogger')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOCAL_STATIC_CDN=os.path.join(os.path.dirname(BASE_DIR),'static_cdn_test')
